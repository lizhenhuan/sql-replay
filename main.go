...
func main() {
	var mode string
	flag.StringVar(&mode, "mode", "", "Mode of operation: parsemysqlslow, parsetidbslow, parsemysqlcsv, parsesqlserver, parsetencentaudit, parseoracle, replay, load, report")
	...
	case "parseoracle":
		ParseOracleAWR(slowLogPath, slowOutputPath)
	case "replay":
	...
	default:
		fmt.Println("Invalid mode. Available modes: parsemysqlslow, parsemysqlcsv, parsetidbslow, parsesqlserver, parsetencentaudit, parseoracle, replay, load, report")
		os.Exit(1)
	}
}
